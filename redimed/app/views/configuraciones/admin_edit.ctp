...
<?php echo $this->Form->create('Configuracion');?>
	<fieldset>
 		<legend><?php __('Edit Configuracion'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Configuracion.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Configuracion.id'))); ?></li>
