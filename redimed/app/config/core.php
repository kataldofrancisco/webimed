 ...
 */
	Configure::write('Session.cookie', 'BPRE2');
...
/**
 * Limite de lugares a desplegar en el mapa
 */
	Configure::write('limite_lugares_retornados', 200);

/**
 * configuraciones de google maps
 */
	Configure::load('googlemap');

/**
 * Hash para validar sesión iniciada
 */
	Configure::write('hash_sesion', 'kjkNbc49J710Mbvc3gf2mVuh65rCgf45Gkjhio864gvkgfvkfre858584');

/**
 *Webservice valorizador
 */
	Configure::load('webservices');

/**
 * Tipo acceso
 * interno/externo
 */
	Configure::write('tipo_acceso', 'externo');
