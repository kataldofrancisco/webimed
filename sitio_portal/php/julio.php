...
//Se recogen los datos del formulario para montar el cuerpo del mensaje.
        $mensaje ="ESCRITO DESDE: Inscripción de Capacitación Julio\n";
...
tu propia direcci?n de correo electr?nico*/
        ...
        if (@mail($destino,'Inscripción de Capacitación Julio',$cuerpo,$cabeceras))
        {

           /*echo ("REALIZADO CON &Eacute;XITO.");*/
           echo "<meta http-equiv=\"refresh\" content=\"0;url=https://www.i-med.cl/sitio_portal/ins_julio_enviado.html\">";
        } else {
