...
//Se recogen los datos del formulario para montar el cuerpo del mensaje.
        $mensaje ="ESCRITO DESDE: Inscripción de Capacitación\n";
...
// Se monta la cabecera del mensaje.
        $cabeceras = "From: capacitaciones@i-med.cl\n";
...
tu propia direcci?n de correo electr?nico*/
        $destino = "capacitaciones@i-med.cl";

        if (@mail($destino,'Inscripción de Capacitación',$cuerpo,$cabeceras))
        {

           /*echo ("REALIZADO CON &Eacute;XITO.");*/
           echo "<meta http-equiv=\"refresh\" content=\"0;url=../ins_enviado.html\">";
        } else {
           /*echo ("SE HA PRODUCIDO UN ERROR");*/
           echo "<meta http-equiv=\"refresh\" content=\"0;url=https://www.i-med.cl/sitio_portal/ins_julio_noenviado.html\">";
        }
